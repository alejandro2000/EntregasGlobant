...
public class FinalStepsLastInfo {
    ...
    public static final By CREDIT_CARD_MONTH = By.cssSelector("#cc_month");
    public static final By CREDIT_CARD_YEAR = By.cssSelector("#ccYear");
